...
/* Lifecycle */
	...
	protected void onCreate(Bundle icicle) {
		...
		_controller.sendMessage(new WillCreatePresentation(is_dual_pane, category_index));
	...
	protected void onStart() {
		super.onStart();
		_controller.sendMessage(WillStartPresentation.DID_START);
	}
...
/* Activity Callbacks */
	...
	protected void onSaveInstanceState(Bundle icicle) {
		icicle.putInt(_KEY_CATEGORY_INDEX, _controller.categoryIndex());
		icicle.putInt(_KEY_ARTICLE_INDEX, _controller.articleIndex());
...
/* NewsReaderPresentation Contract */
	...
	public void attachController(Controller controller) {
		if (!(controller instanceof NewsReaderController))
			throw new IncompatibleControllerException(controller);
		_controller = (NewsReaderController) controller;	
		if (BuildConfig.DEBUG) Log.d(_TAG, "controller attached");
	}
		...
		new AlertDialog.Builder(this)
			...
			.setItems(categories, new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
						_controller.sendMessage(new CategorySelected(which));
					}
			})
			.create()
			.show();
...
/* NewsReaderNavigationCallback */
	...
	public void onCategorySelected(int category_index) {
		_controller.sendMessage(new CategorySelected(category_index));
	}
...
/* Helpers */
	...
	private void restoreSelection(Bundle icicle) {
	    if (icicle != null) {
	      ...
	      _controller.sendMessage(new WillRestorePresentation(category_index, article_index));
	    }
	  }
	...
	private NewsReaderController _controller;
